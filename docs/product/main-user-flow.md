...
flowchart TD
    ...
    P -->|Открыть / создать| L["Экран «Конструктор тренировок»"]
    B -->|Плашка конструктора| L
    B -->|Карточка счётчика| I
    B -->|Иконка профиля| PR["Профиль"]
...
- **Нужно управление:** панель запуска и плашка на главной ведут на экран
...
- История, конструктор и профиль открываются с главной одним нажатием.
